...
namespace Ninja_Dash
{
    ...
    public class AudioManager : GameComponent
    {
        ...
        public static void Initialize(Game game)
        {
            ...
            audioManager.soundBank = new Dictionary<string, SoundEffect>();
        ...
        public static void LoadSound(string contentName, string alias)
        {
            ...
            {
                audioManager.soundBank.Add(alias, soundEffect);
            }
        }
        ...
        {
            LoadSound("Game_Over", "Game_Over");
            LoadSound("PlayerFall", "PlayerFall");
            LoadSound("PlayerJump", "PlayerJump");
            LoadSound("Shuriken_Metal_Hit", "Shuriken_Metal_Hit");
            LoadSound("Shuriken_Throw", "Shuriken_Throw");
            LoadSound("Sword_Slash", "Sword_Slash");
            LoadSound("GemCollected", "GemCollected");
